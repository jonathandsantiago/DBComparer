...
namespace ComparadorDadosSQL.Sistemas
{
    public static class SybaseOdbcManager
    {
        ...
        private static string dsnName = "Sybase ODBC VSicoci Services";
        ...
        public static string GetCurrentDsn()
        {
            ...
            {
                throw new InvalidOperationException("Nenhum DSN ODBC foi definido e o serviço não conseguiu criar.");
            }
        }
    }
}
